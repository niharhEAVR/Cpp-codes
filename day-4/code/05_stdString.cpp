...
int main()
{
    ...
    // Use a raw array
    const char *planet2{"Earth. Where the sky is blue Earth."};
    planet2 = "Earth. Where the sky is blue Earth. Where the sky is blue Earth. Where ";
    std::cout << "planet2 : " << planet2 << std::endl;
