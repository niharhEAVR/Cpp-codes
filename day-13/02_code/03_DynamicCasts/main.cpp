...
int main()
{
	...
	// animal1->do_some_feline_thingy(); // Won't work because animal1 is of type Animal*
	...
	/* --- We can also do the transformation downstream for references --- */
	...
	// Calling non virtual methods on animal_ref won't work, because animal_ref is of type Animal&
